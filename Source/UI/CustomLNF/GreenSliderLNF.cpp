...
#include "GreenSliderLNF.h"

GreenSliderLNF::GreenSliderLNF()
{
}
...
void GreenSliderLNF::drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPos,
